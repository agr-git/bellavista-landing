/**
 * /admin/cms/stay — Stay section editor.
...
export default async function StayCmsPage() {
  await requireAdmin();
  ...
  return (
    <div>
      ...
      <h1 className="font-serif text-h2 text-ink mt-2 mb-6">Stay CMS</h1>
      <div className="border border-line rounded-[var(--radius)] p-8 text-center">
        ...
        <p className="font-sans text-body text-ink-2">
          The Stay section editor (image upload + copy edit) is coming in Phase
          3. For now, replace photos in{" "}
